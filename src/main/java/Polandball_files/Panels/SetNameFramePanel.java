...
import Polandball_files.Frames.LevelFrame;
import Polandball_files.Frames.SetNameFrame;
...
import static Polandball_files.Panels.StartPanel.setnameframe;
...
public class SetNameFramePanel extends JPanel implements ActionListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if(source==Okey){
            ...
            if(nickname.length() > 10 || nickname.indexOf(" ") != -1 || nickname.length() < 1){
