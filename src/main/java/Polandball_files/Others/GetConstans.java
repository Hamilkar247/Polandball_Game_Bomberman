package Polandball_files.Others;
...
public final class GetConstans {
     ...
     */
    public static final String Config = "src\\main\\resources\\Config\\config.xml";
    ...
    public static void read_on_config(){
        try {
            ...
            System.out.println("Blad w scieszce pliku config.xml");
            e.printStackTrace();
    ...
    public static void read_on_level(int level){
        try {
            ...
            /////////NIE MOGE ZNALEZC///PauseActive=true;//zatrzymanie gry
    ...
    public static void read_path_to_graphics() {
        try {
            ...
            //File file = new File(this.getClass().getResource("//Config//config.xml"));
            File file = new File("src\\main\\resources\\Config\\PathToGraphics.xml");
            System.out.println(file.getPath());
            DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
            DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
            Document doc = dBuilder.parse(file);
    ...
    static String create_path_to_level(int level){
        String first_part="src\\main\\resources\\Level_Folder\\Level";
